      ...
      >
        ...
        <div className="rounded-3xl bg-card border border-border p-8">
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            <div>
              <label className="text-xs font-medium text-muted mb-1.5 block">{t.login.email}</label>
            ...
            <div>
              <label className="text-xs font-medium text-muted mb-1.5 block">{t.login.password}</label>
              <div className="flex items-center gap-2 bg-background border border-border rounded-xl px-4 py-3 focus-within:border-border-light transition-colors">
